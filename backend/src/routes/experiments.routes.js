...
const { experimentResponses } = require('../contracts/experiment.responses');
...
router.post('/:key/assignments', limiter, authenticateOptional, responseContract(experimentResponses.assign), controller.assign);
router.post('/:key/exposures', limiter, authenticateOptional, responseContract(experimentResponses.expose), controller.expose);
