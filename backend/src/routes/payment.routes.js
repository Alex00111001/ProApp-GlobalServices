...
const { errorResponseContract, responseContract } = require('../shared/http/response-contract');
...
router.post('/cash', errorResponseContract(paymentResponses.cash), paymentController.rejectRetiredCashPayment);
